...
urlpatterns = [
    ...
    path('<int:movie_id>/comments/new/', views.new_comment, name='new_comment'),
    path('<int:movie_id>/comments/<int:comment_id>/delete/', views.delete_comment, name='delete_comment'),
]
